...
\large Manuscript: ``Architecture of the Avalia+Tec Platform with Cryptographic Security for\\
...
\begin{enumerate}[nosep]
  ...
  \item Terminology correction. Every occurrence of ``immutable'' has been replaced with ``tamper-evident'' throughout the manuscript, the abstract, highlights, the architecture diagram label, and all technical descriptions.
\end{enumerate}
