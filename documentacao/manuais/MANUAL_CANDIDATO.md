...
Este manual explica, em linguagem simples, como o candidato realiza a inscrição no Sistema PLANTERR. Ao final do processo, o sistema gera um PDF oficial contendo o número de protocolo da inscrição e um código hash SHA-256 para verificação de autenticidade.
