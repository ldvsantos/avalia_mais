...
// Fallback para assets do pitch deck (caso não estejam dentro de /src no deploy)
// Ex.: /projeto_centelha/prints/manual/*.png
app.use('/projeto_centelha/prints', express.static(path.join(__dirname, '..', 'projeto_centelha', 'prints')));
...
app.get(`/secret/${ADMIN_SECRET}/admin/allocation/pdf`, checkAdminIP, adminAuth, async (req, res) => {
  return adminController.allocationPdf(req, res);
});
